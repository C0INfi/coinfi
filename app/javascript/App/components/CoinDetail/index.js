	  ...
	  <div className="bg-white mb2">
		...
		<div className="pa4 pt0">
		  <div className="flex justify-center items-center mb3">
			{/* <img alt="Bitcoin" className="w3e h3e mr3 a1" height="32" src="https://gitcdn.link/repo/cjdowner/cryptocurrency-icons/master/svg/color/btc.svg" width="32"> */}
			  <h1 className="ma0 lh-solid"><span className="fw4">Bitcoin</span>
				<span className="f6 fw9 sans-alt" id="symbol">BTC</span>
			  </h1>
			</div>
			<div className="f3 tc">$7,335.23<span className="smaller2 b ml2">
				<span className="sunset">-4.39%</span></span>
			</div>
		  </div>
		</div>
		<div className="bg-white pa4 mb2">
		  <div className="row nt4 tc fw6">
			<div className="stat-block col-xs-6 col-sm-3 col-md-12 col-lg-6 mt4">
			  <label>Volume (24 h)</label>$4.18B
			  <div className="dib f7 ml1">USD</div>
			</div>
			<div className="stat-block col-xs-6 col-sm-3 col-md-12 col-lg-6 mt4">
			  <label>Circulation</label>17.08M
			  <div className="dib f7 ml1">BTC</div>
			</div>
			<div className="stat-block col-xs-6 col-sm-3 col-md-12 col-lg-6 mt4">
			  <label>Market Cap</label>$125.32B
			  <div className="dib f7 ml1">USD</div>
			</div>
			<div className="stat-block col-xs-6 col-sm-3 col-md-12 col-lg-6 mt4">
		...
		<div className="bg-white tc f7 pa4 mb2">Last updated: 2 minutes ago</div>
