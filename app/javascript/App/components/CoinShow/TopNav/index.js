...
class TopNav extends React.Component {
  componentDidMount() {
    ...
    OSREC.superslide = function(p) {
      ...
      me.p.onOpen =
        typeof me.p.onOpen == 'function' ? me.p.onOpen : function() {}
      me.p.beforeClose =
      ...
      switch (me.p.animation) {
        ...
        case 'slideRight': {
          ...
          me.p.touchStartFunction = function(e) {
            ...
            if (!me.p.isOpen && startX < clientWidth - me.p.dragThreshold)
              return
  ...
  render() {
    return (
      <div>
        {' '}
        <div id="content" style={{ minHeight: '100vh', minWidth: '100vw' }}>
            {this.props.children}
        </div>
        <div id="menu" style={{ background: '#ccc' }}>
          Menu
        </div>
      </div>
    )
